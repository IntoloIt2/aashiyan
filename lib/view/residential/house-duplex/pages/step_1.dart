                      ...
                      onChanged: (it) => setState(
                        () {
                          ...
                          if (printData['project'] != null &&
                              printData != null) {
                            printData['project']['prefix'] = selectedItems;
                          }
                        },
                      ),
                    ),
          ...
          Row(
            children: [
              ...
              Checkbox(
                ...
                value: printData != null
                    ? printData['project'] != null
                        ? printData["project"]["west_property"] == WEST_PROPERTY
                            ? true
                            : westRoad
                        : westRoad
                    : westRoad,
              ...
              Checkbox(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      southRoad = false;
                      if (printData != null && printData['project'] != null) {
                        printData["project"]["south_property"] = otherSouth;
                      }
                      // if (otherSouth = true) {
                      //   otherSouth = false;
                      // }
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        hint: printData['project'] != null
                            ...
                            ? Text("${levels[printData['project']['level']]}")
                            // : Text(selectedLevel)
                            : Text(selectedLevel),
                        // value: selectedLevel,
                        icon: const Icon(Icons.keyboard_arrow_down_sharp),
