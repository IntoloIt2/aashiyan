        ...
        if (viewData != null) {
          ...
          indoorNotRequired =
              viewData["bungalow_basement"]['indoor_play_req'] == 0
                  ? true
                  : false;
          indoorPlayLengthController = viewData["bungalow_basement"]
                      ["indoor_play_length"] !=
                  null
              ? int.parse(viewData["bungalow_basement"]["indoor_play_length"])
              : 0;
          indoorPlayWidtController = viewData["bungalow_basement"]
                      ["indoor_play_width"] !=
                  null
              ? int.parse(viewData["bungalow_basement"]["indoor_play_width"])
              : 0;
          sepratedShadeController =
          ...
          indoorPlaySpecificRequirement =
              viewData["bungalow_basement"]["indoor_play_specific_req"] != null
                  ? viewData["bungalow_basement"]["indoor_play_specific_req"]
                  : '';
          barRequirement =
          ...
          spaNotRequired =
              viewData["bungalow_basement"]['spa_req'] == 0 ? true : false;
                          ...
                          child: TextFormField(
                            initialValue: viewData != null &&
                                    viewData["bungalow_basement"]
                                            ["office_length"] !=
                                        null
                                ? viewData["bungalow_basement"]["office_length"]
                                : '',
                  ...
                  child: TextFormField(
                    initialValue: viewData != null &&
                            viewData["bungalow_basement"]
                                    ["office_specific_req"] !=
                                null
                        ? viewData["bungalow_basement"]["office_specific_req"]
                        : '',
                    style: const TextStyle(fontSize: 14),
                    decoration: const InputDecoration(
                  ...
                  child: TextFormField(
                    initialValue: viewData != null &&
                            viewData["bungalow_basement"]
                                    ["servent_quarter_width"] !=
                                null
                        ? viewData["bungalow_basement"]["servent_quarter_width"]
                        : '',
                    style: const TextStyle(fontSize: 14),
                    decoration: const InputDecoration(
                        hintText: "width",
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: const InputDecoration(
                                ...
                                contentPadding: EdgeInsets.all(8)),
                            onChanged: (value) {
                              homeTheaterLengthController = int.parse(value);
                            },
                          ),
                        ),
                      ),
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: const InputDecoration(
                                ...
                                contentPadding: EdgeInsets.all(8)),
                            onChanged: (value) {
                              homeTheaterWidthController = int.parse(value);
                            },
                          ),
                        ),
                      ),
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                        ...
                        contentPadding: EdgeInsets.all(8)),
                    onChanged: (value) {
                      additionalCarsController = int.parse(value.toString());
                    },
                  ),
                ),
              ),
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                        ...
                        contentPadding: EdgeInsets.all(8)),
                    onChanged: (value) {
                      additionalParkingSpecificController = value.toString();
                    },
                  ),
                ),
              ),
                          ...
                          child: TextFormField(
                            initialValue: viewData != null &&
                                    viewData["bungalow_basement"]
                                            ["bar_length"] !=
                                        null
                                ? viewData["bungalow_basement"]["bar_length"]
                                : '',
                            style: const TextStyle(fontSize: 14),
                            decoration: const InputDecoration(
                                hintText: "Length",
                                ...
                                contentPadding: EdgeInsets.all(8)),
                            onChanged: (value) {
                              barLengthController = int.parse(value.toString());
                            },
                          ),
                        ),
                      ),
                          ...
                          child: TextFormField(
                            initialValue: viewData != null &&
                                    viewData["bungalow_basement"]
                                            ["bar_width"] !=
                                        null
                                ? viewData["bungalow_basement"]["bar_width"] !=
                                        null
                                    ? viewData["bungalow_basement"]["bar_width"]
                                    : ''
                                : '',
                            ...
                            decoration: const InputDecoration(
                                ...
                                contentPadding: EdgeInsets.all(8)),
                            onChanged: (value) {
                              barWidthController = int.parse(value.toString());
                            },
                          ),
                        ),
                      ),
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                        ...
                        contentPadding: EdgeInsets.all(8)),
                    onChanged: (value) {
                      barSpecificRequiremrnt = int.parse(value.toString());
                    },
                  ),
                ),
              ),
                          ...
                          child: TextFormField(
                            initialValue: viewData != null &&
                                    viewData["bungalow_basement"]
                                            ["gym_length"] !=
                                        null
                                ? viewData["bungalow_basement"]["gym_length"]
                                : '',
                            style: const TextStyle(fontSize: 14),
                            decoration: const InputDecoration(
                                hintText: "Length",
                                ...
                                contentPadding: EdgeInsets.all(8)),
                            onChanged: (value) {
                              gymLengthController = int.parse(value.toString());
                            },
                          ),
                        ),
                      ),
                  ...
                  children: [
                    ...
                    Material(
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          initialValue: viewData != null &&
                                  viewData["bungalow_basement"]["gym_width"] !=
                                      null
                              ? viewData["bungalow_basement"]["gym_width"]
                              : '',
                          style: const TextStyle(fontSize: 14),
                          decoration: const InputDecoration(
                              ...
                              contentPadding: EdgeInsets.all(8)),
                          onChanged: (value) {
                            gymWidthController = int.parse(value.toString());
                          },
                        ),
                      ),
                    ),
            ...
            children: [
              ...
              Material(
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    initialValue: viewData != null &&
                            viewData["bungalow_basement"]["gym_specific_req"] !=
                                null
                        ? viewData["bungalow_basement"]["gym_specific_req"]
                        : '',
                    style: const TextStyle(fontSize: 14),
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Checkbox(
                              ...
                              checkColor: Colors.white,
                              value: viewData != null
                                  ? viewData['bungalow_basement']["spa_req"] ==
                                          0
                                      ? true
                                      : spaNotRequired
                                  : spaNotRequired,
                          ...
                          child: TextFormField(
                            initialValue: viewData != null &&
                                    viewData["bungalow_basement"]
                                            ["spa_length"] !=
                                        null
                                ? viewData["bungalow_basement"]["spa_length"]
                                : '',
                            style: const TextStyle(fontSize: 14),
                            decoration: const InputDecoration(
                                hintText: "Length",
                          ...
                          child: TextFormField(
                            initialValue: viewData != null &&
                                    viewData["bungalow_basement"]
                                            ["spa_width"] !=
                                        null
                                ? viewData["bungalow_basement"]["spa_width"]
                                : '',
                            style: const TextStyle(fontSize: 14),
                            decoration: const InputDecoration(
                                hintText: "Width",
                                ...
                                contentPadding: EdgeInsets.all(8)),
                            onChanged: (value) {
                              spaWidthController = int.parse(value.toString());
                            },
                          ),
                        ),
                      ),
            ...
            children: [
              ...
              Material(
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    initialValue: viewData != null &&
                            viewData["bungalow_basement"]["spa_specific_req"] !=
                                null
                        ? viewData["bungalow_basement"]["spa_specific_req"]
                        : '',
                    style: const TextStyle(fontSize: 14),
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                        icon: const Visibility(
                            visible: false, child: Icon(Icons.arrow_downward)),
                        hint: viewData != null
                            ? viewData["bungalow_basement"]["garden_type"] !=
                                    null
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    initialValue: viewData != null &&
                            viewData["bungalow_basement"]["spa_specific_req"] !=
                                null
                        ? viewData["bungalow_basement"]["garden_specific_req"]
                        : '',
                    style: const TextStyle(fontSize: 14),
                    decoration: const InputDecoration(
                        hintText: "Special requirement",
