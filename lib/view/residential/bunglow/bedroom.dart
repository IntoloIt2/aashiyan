...
// import '../../../controller/bedroom_controller.dart';
...
//   final BedRoomController c = Get.put(BedRoomController());
...
//               // for (int i = 0; i < bedModelList.length; i++) {
//               //   print(i);
//               //   print(bedModelList[i].bedroomLength);
//               // }
//               // print(bed.personBedroomController);
//               print(bedroomList.map(
//                 (item) {
//                   print("${c.bedroomLength} length");
//                 },
//               ));
//             },
//             child: Container(
...
//   //     bedModelList[i].bedroom = widget.personBedroomController;
//   //     bedModelList[i].bedroomLength = widget.bedroomLength;
//   //   }
//   // }
...
//                         onChanged: (value) {
//                           setState(() {
//                             print(widget.personBedroomController);
...
//                         onChanged: (value) {
//                           setState(() {
//                             c.bedroomLength = value.obs;
//                             print(c.bedroomLength);
//                             // if (value != null) {
