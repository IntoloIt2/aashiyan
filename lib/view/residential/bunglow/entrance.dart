  ...
  Future<void> getData() async {
    try {
      ...
      var response = await http.get(Uri.parse(
          "http://192.168.1.99:8080/sdplserver/api/edit-bungalow-entrance/140"));
                        ...
                        child: Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                                ...
                                hint: printData["bungalow_entrance"]["floor"] !=
                                        null
                  ...
                  if (securityRequired == true) ...[
                    ...
                    Row(
                      children: [
                        ...
                        requirementTextFieldCont(height, width, 0.04, 0.15,
                            "Width", securityKioskWidthController),
                        valueContainer(height, width, size, 0.04, 0.05),
                        SizedBox(
                          width: width * 0.01,
                        ),
                  ...
                  if (requiredVeranda == true) ...[
                    ...
                    Row(
                      children: [
                        ...
                        requirementTextFieldCont(height, width, 0.04, 0.15,
                            "length", verandaLengthController),
                        valueContainer(height, width, size, 0.04, 0.05),
                        SizedBox(
                          width: width * 0.02,
                        ),
